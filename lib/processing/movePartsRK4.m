...
U10_half = velocities.U10ts1 + (velocities.U10ts2-velocities.U10ts1)/2;
V10_half = velocities.V10ts1 + (velocities.V10ts2-velocities.V10ts1)/2;
...
for HeightLayer = 1 : spillLocation.n_Heights
  ...
  if HeightLayer == 5 %10 m 
          % Interpolate U and V to position1
      Upart1 = interp2(WindFile.U10lon, WindFile.U10lat, velocities.U10ts1, position1lon, position1lat);
      Vpart1 = interp2(WindFile.U10lon, WindFile.U10lat, velocities.V10ts1, position1lon, position1lat);
      ...
      Upart2 = interp2(WindFile.U10lon, WindFile.U10lat, U10_half, position2lon, position2lat);
      Vpart2 = interp2(WindFile.U10lon, WindFile.U10lat, V10_half, position2lon, position2lat);
      ...
      Upart3 = interp2(WindFile.U10lon, WindFile.U10lat, U10_half, position3lon, position3lat);
      Vpart3 = interp2(WindFile.U10lon, WindFile.U10lat, V10_half, position3lon, position3lat);
    ...
    %}
      ...
      Upart4 = interp2(WindFile.U10lon, WindFile.U10lat, velocities.U10ts2, position4lon, position4lat);
      Vpart4 = interp2(WindFile.U10lon, WindFile.U10lat, velocities.V10ts2, position4lon, position4lat);
      ...
      Particles.Lat(height_ind) = newLatP';
      Particles.Lon(height_ind) = newLonP';
    ...
    Particles.Age_days(Particles.Status == 1) = Particles.Age_days(Particles.Status == 1) + ts*LagrTimeStep.InDays;
      ...
      Vpart3 = interp2(WindFile.Vlon, WindFile.Vlat, V_half(:,:,HeightLayer), position3lon, position3lat);
    ...
    %}
      ...
      Vpart4 = interp2(WindFile.Vlon, WindFile.Vlat, velocities.Vts2(:,:,HeightLayer), position4lon, position4lat);
